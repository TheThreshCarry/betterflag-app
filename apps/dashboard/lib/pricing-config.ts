...
export const PRICING_SPEC: readonly PricingTier[] = [
  ...
  },
  {
    ...
    price: fmtUsd(2499),
    period: "/mo",
    includedEvaluations: 5_000_000,
    overagePerMillionCents: 400,
    overage: overageLine(400),
    projects: null,
    agentKeys: null,
    features: [
      "5M evaluations / mo",
  ...
  },
  {
    ...
    price: fmtUsd(9999),
    period: "/mo",
    includedEvaluations: 50_000_000,
